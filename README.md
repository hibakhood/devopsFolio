# Software Developer Folio ⚡️ [![GitHub](https://img.shields.io/github/license/saadpasta/developer-portfolio?color=blue)](https://github.com/hibakhood/devopsFolio/blob/master/LICENSE) [![GitHub stars](https://img.shields.io/github/stars/hibakhood/devopsFolio)](https://github.com/hibakhood/devopsFolio/stargazers)  [![All Contributors](https://img.shields.io/badge/all_contributors-4-orange.svg?style=flat-square)](#contributors)
...
If you'd like to **contribute** and make this much better for other users, have a look at [Issues](https://github.com/hibakhood/devopsFolio/issues).

Created something awesome for your fork of the portfolio and want to share it? Feel free to open a [pull request](https://github.com/hibakhood/devopsFolio/pulls).
...
To view a live example, **[click here](https://hibakhood.github.io/)**.
...
git clone https://github.com/hibakhood/devopsFolio.git
...
If the above solution still doesn't work, visit the [wiki page](https://github.com/hibakhood/devopsFolio/wiki/Github-Setup-For-Open-Source-Projects).
...
const greeting = {
  ...
  resumeLink: "https://drive.google.com/file/d/1EfDAQq32m3iCszraPS1osAJL85GCkHmSN/view?usp=sharing"
};

const socialMediaLinks = {
  /* Your Social Media Link */
  github: "https://github.com/hibakhood",
